...
# Preprocess
# -------------------------
def input_layout_from_shape(shape) -> str:
    """Infer NCHW vs NHWC from ONNX input shape (e.g. [N,3,H,W] vs [N,H,W,3])."""
    if len(shape) != 4:
        return "nchw"
