...
class ArcFaceEmbedderONNX:
    ...
    def __init__(
        ...
        from .embed import input_layout_from_shape, preprocess_arcface_face
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--camera-index", type=int, default=0, help="OpenCV camera index (0, 1, or 2).")
